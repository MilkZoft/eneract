    ...
    <div id="top" class="header">
        ...
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <img src="<?php echo $this->themePath; ?>/img/mobile-dash-4-on-device.png" style="padding:20px" width="150" style="float:left">
            <img src="<?php echo $this->themePath; ?>/img/logoSmall.png" width="200px" title="Eneract"/>
