 ...
 * Facebook App
 */
define("FB_APP_ID", "611173662270444");
define("FB_APP_SECRET", "51d78a56dfce907129d3782a40637fd0");
define("FB_APP_SCOPE", "email,user_birthday,read_stream");
define("FB_APP_FIELDS", "id,name,email,birthday,picture,username");
define("FB_APP_URL", "http://www.eneract.co/en/users/facebook/");
