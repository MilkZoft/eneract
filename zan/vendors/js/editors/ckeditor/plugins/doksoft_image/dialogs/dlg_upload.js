(function () {
    var b = function (w) {
        ...
        return {
            ...
            contents: [{
                id: "info",
                label: w.lang.doksoft_image.status_file_upload,
                accessKey: "I",
                elements: [{
                    type: "vbox",
                    padding: 0,
                    children: [{
                        ...
                        children: [{
                            ...
                            id: "message",
                            html: w.lang.doksoft_image.status_file_upload_success,
                            hidden: true
                        }, {
                            type: "html",
                            style: "margin-top:30px;width:40px;height:40px;font-weight:bold;",
                            id: "message1",
                            html: w.lang.doksoft_image.status_file_upload_wait,
                            hidden: true
                        }, {
                            type: "file",
                            id: "upload",
                            ...
                            filebrowser: {
                                action: "QuickUpload",
                                target: "info:txtUrl",
                                url: w.config.filebrowserImageUploadUrl,
                                onSelect: function (d, f) {
                                    if (d) {
                                        ...
                                        alert(w.lang.doksoft_image.status_file_upload_fail);
                                    }
                                    return false;
                                }
                            },

                            label: w.lang.doksoft_image.label_send_to_server, "for": ["info", "upload"]
                        }, {
                            id: "txtUrl",
                            type: "text",
                            label: w.lang.common.url,
                            required: true,
                            onChange: function () {
                            ...
                            commit: function (f, e) {
                                var d = this;
                                if (f == v && (d.getValue() || d.isChanged())) {
                                    e.data("cke-saved-src", d.getValue());
                                    e.setAttribute("src", d.getValue());
                                } else {
                                    e.setAttribute("src", "");
                                    e.removeAttribute("src");
                                }
                            },
                            validate: CKEDITOR.dialog.validate.notEmpty(w.lang.doksoft_image.label_no_file),
                            hidden: true
                        }]
                    }]
                }]
